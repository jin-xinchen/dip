...
//      ON:  K 	L 	M 	N 	P
        ...
        pathFolder2 = Paths.get(System.getProperty("user.dir"), "output/zipcodes02/FSA-X-NU_NT-02.txt");
        wf2 = String.valueOf(pathFolder2);
        handleFSAwithSingleLetter(src2,wf2,"X");

        pathFolder2 = Paths.get(System.getProperty("user.dir"), "output/zipcodes02/FSA-Y-YT.txt");
        wf2 = String.valueOf(pathFolder2);
        handleFSAwithSingleLetter(src2,wf2,"Y");
