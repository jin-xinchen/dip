...
public class handleTxt04 {
    public static void main1(String[] args) {
        ...
        String [] keys= {"H","J"};
        handleTxt04.createFSA04(pathFolderSrc.toString(),pathFolderTarget.toString(),keys[0],keys[1]);
    }
...
//        handleFSA0101(src2,wf2,"G");
    ...
    //Setp 3 create FSA-H-ON.txt and FSA-J-MB-01.txt
...
//           	E 	G 	H 	J 	K 	L 	M 	N 	P 	R 	S 	T 	V 	X 	Y
        Path pathFolder2;
        pathFolder2 = Paths.get(System.getProperty("user.dir"), "output/zipcodes02/FSA-H-ON.txt");
        String wf = String.valueOf(pathFolder2);
        handleFSA0101(src2, wf,"H");

        pathFolder2 = Paths.get(System.getProperty("user.dir"), "output/zipcodes02/FSA-J-MB-01.txt");
        String wf2 = String.valueOf(pathFolder2);
        handleFSA0101(src2,wf2,"J");
...
//           	E 	G 	H 	J 	K 	L 	M 	N 	P 	R 	S 	T 	V 	X 	Y
        ...
        String targetFileName = "FSA-H-ON";//System.nanoTime();
        try {
        ...
        String targetFileName2 = "FSA-J-MB-01";//System.nanoTime();
        try {
            createExcel(src2,targetFileName2);
        } catch (FileNotFoundException e) {
            e.printStackTrace();
        }
...
//                Files.createDirectory(screenshotFolder);
    ...
    public static void createFSA04(String src, String wf,String key1,String key2){
        try {
