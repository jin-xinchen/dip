...
public class handleTxt13{
    static int n =13;
    static Path pathFolderSrc = Paths.get(System.getProperty("user.dir"), "zipcodes/FSA-"+n+".txt");//origin txt file
    static Path pathFolderTarget = Paths.get(System.getProperty("user.dir"), "output/zipcodes01/FSA-"+n+".txt");
    static Path t0 = Paths.get(System.getProperty("user.dir"), "output/zipcodes01/FSA-"+n+"-01.txt"); // copy for origin txt file
...
//      ON:  K 	L 	M 	N 	P
        ...
        pathFolder2 = Paths.get(System.getProperty("user.dir"), "output/zipcodes02/FSA-X-NU_NT-01.txt");
        wf2 = String.valueOf(pathFolder2);
        handleFSAwithSingleLetter(src2,wf2,"X");

        pathFolder2 = Paths.get(System.getProperty("user.dir"), "output/zipcodes02/FSA-V-BC-02.txt");
        wf2 = String.valueOf(pathFolder2);
        handleFSAwithSingleLetter(src2,wf2,"V");

//        pathFolder2 = Paths.get(System.getProperty("user.dir"), "output/zipcodes02/FSA-R-MB.txt");
//        wf2 = String.valueOf(pathFolder2);
//        handleFSAwithSingleLetter(src2,wf2,"R");
    }
    ...
    public static void createFSAtoSingleCol(String src, String wf,String key1,String key2,String key3){
        try {
            ...
            while (myReader.hasNextLine()) {
                ...
                if(data.substring(0,3).equals("V6R")){
