...
//
        pathFolder2 = Paths.get(System.getProperty("user.dir"), "output/zipcodes02/FSA-P-ON-01.txt");
        wf2 = String.valueOf(pathFolder2);
        handleFSAwithSingleLetter(src2,wf2,"P");

        pathFolder2 = Paths.get(System.getProperty("user.dir"), "output/zipcodes02/FSA-N-ON-02.txt");
        wf2 = String.valueOf(pathFolder2);
