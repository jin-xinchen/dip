...
//      ON:  K 	L 	M 	N 	P
        ...
        pathFolder2 = Paths.get(System.getProperty("user.dir"), "output/zipcodes02/FSA-S-SK-01.txt");
        wf2 = String.valueOf(pathFolder2);
        handleFSAwithSingleLetter(src2,wf2,"S");

        pathFolder2 = Paths.get(System.getProperty("user.dir"), "output/zipcodes02/FSA-P-ON-02.txt");
        wf2 = String.valueOf(pathFolder2);
        handleFSAwithSingleLetter(src2,wf2,"P");
