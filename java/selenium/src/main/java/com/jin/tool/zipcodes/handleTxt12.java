...
//      ON:  K 	L 	M 	N 	P
        ...
        pathFolder2 = Paths.get(System.getProperty("user.dir"), "output/zipcodes02/FSA-T-AB-02.txt");
        wf2 = String.valueOf(pathFolder2);
        handleFSAwithSingleLetter(src2,wf2,"T");

        pathFolder2 = Paths.get(System.getProperty("user.dir"), "output/zipcodes02/FSA-V-BC-01.txt");
        wf2 = String.valueOf(pathFolder2);
