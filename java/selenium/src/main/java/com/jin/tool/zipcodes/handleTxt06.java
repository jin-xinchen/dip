...
public class handleTxt06 {
    static int n =6;
    static Path pathFolderSrc = Paths.get(System.getProperty("user.dir"), "zipcodes/FSA-0"+n+".txt");
    static Path pathFolderTarget = Paths.get(System.getProperty("user.dir"), "output/zipcodes01/FSA-0"+n+".txt");
    static Path t0 = Paths.get(System.getProperty("user.dir"), "output/zipcodes01/FSA-0"+n+"-01.txt");
...
//      ON:  K 	L 	M 	N 	P
        //QC:G 	H 	J
        Path pathFolder2;
        pathFolder2 = Paths.get(System.getProperty("user.dir"), "output/zipcodes02/FSA-J-QC-03.txt");
        String wf2 = String.valueOf(pathFolder2);
        handleFSAwithSingleLetter(src2,wf2,"J");
        pathFolder2 = Paths.get(System.getProperty("user.dir"), "output/zipcodes02/FSA-K-ON.txt");
        wf2 = String.valueOf(pathFolder2);
        handleFSAwithSingleLetter(src2,wf2,"K");
        pathFolder2 = Paths.get(System.getProperty("user.dir"), "output/zipcodes02/FSA-L-ON-01.txt");
        wf2 = String.valueOf(pathFolder2);
...
//            	NB 	QC 	ON 	MB 	SK 	AB 	BC 	NU/NT 	YT
//           	E 	G 	H 	J 	K 	L 	M 	N 	P 	R 	S 	T 	V 	X 	Y
        String name="FSA-J-QC-03";
        Path pathFolder2;
        pathFolder2 = Paths.get(System.getProperty("user.dir"), "output/zipcodes02/"+name+".txt");
        String src2 = String.valueOf(pathFolder2);
        String targetFileName2 = "FSA-J-QC-03";//System.nanoTime();
        try {
            createExcel(src2,targetFileName2,"FSA-J-QC-03");
...
//                data.replaceAll("/^ [BC][0-9][A-Z]/g",",B");
                ...
                if(!key2.equals("")) {
                    String s2 = s.replaceAll(" " + key2, line + key2);
                    if(!key3.equals("")){
                        String s3 = s2.replaceAll(" " + key3, line + key3);
                        myWriter.append(s3);
                    }else{
                        myWriter.append(s2);
                    }
