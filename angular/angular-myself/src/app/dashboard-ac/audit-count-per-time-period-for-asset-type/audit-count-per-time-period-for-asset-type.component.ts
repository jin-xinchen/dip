...
//
@Component({
  selector: 'audit-count-per-time-period-for-asset-type',
  templateUrl: './audit-count-per-time-period-for-asset-type.component.html',
  styleUrls: ['../default-dash-widget/default-dash-widget.component.css','./audit-count-per-time-period-for-asset-type.component.css']
})
export class AuditCountPerTimePeriodForAssetTypeComponent implements OnInit {
