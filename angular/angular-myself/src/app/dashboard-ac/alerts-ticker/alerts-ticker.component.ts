...
@Component({
  selector: 'alerts-ticker',
  templateUrl: './alerts-ticker.component.html',
  styleUrls: ['../default-dash-widget/default-dash-widget.component.css','./alerts-ticker.component.css']
})
export class AlertsTickerComponent implements OnInit {

 @Input()
  defaultData: WidgetModel;
